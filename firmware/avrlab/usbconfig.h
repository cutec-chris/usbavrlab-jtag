 ...
 */
#ifndef ISUSBASP
 #define USB_CFG_VENDOR_NAME     'C', 'a', 'h', 'y', 'a', ' ', 'W', 'i', 'r', 'a', 'w', 'a', 'n'
 #define USB_CFG_VENDOR_NAME_LEN 13
 #define USB_CFG_DEVICE_NAME     'u', 's', 'b', 'v', 'l', 'a', 'b', '-', 'j', 't', 'a', 'g'
 #define USB_CFG_DEVICE_NAME_LEN 12
#else
 #define	USB_CFG_VENDOR_NAME     'C', 'a', 'h', 'y', 'a', ' ', 'W', 'i', 'r', 'a', 'w', 'a', 'n', ' ', '2'
 #define USB_CFG_VENDOR_NAME_LEN 15
 #define	USB_CFG_DEVICE_NAME		'C', 'a', 'h', 'y', 'a', ' ', '2'
